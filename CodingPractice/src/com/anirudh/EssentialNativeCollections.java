 ...
 */
public class EssentialNativeCollections {
...
//        class TreeNode {
//            public int val;
//            public com.anirudh.datastructures.trees.TreeNode left;
//            public com.anirudh.datastructures.trees.TreeNode right;
//
//            TreeNode() {
//            }
//
...
//            }
//
//            TreeNode(int val, com.anirudh.datastructures.trees.TreeNode left, com.anirudh.datastructures.trees.TreeNode right) {
//                this.val = val;
//                this.left = left;
//                this.right = right;
//            }
...
//        PriorityQueue<Pair> pQueue = new PriorityQueue<>(Comparator.comparingInt(a -> a.count));
//        priorityQueue.poll();
...
//        Deque<Integer> deq2 = new ArrayDeque<>();
        ...
        String foo = "abc";
        System.out.println(foo.codePointAt(0));

 ...
 */
    //TODO: Use sentinel nodes for head and tail
public class LRUCache_DLL {
    ...
    private final Map<Integer, QueueNode> cache = new HashMap<>(); //KEY to the queuenode in the queue
    ...
    public static void main(String[] args) {
        LRUCache_DLL cache = new LRUCache_DLL(2 /* capacity */);

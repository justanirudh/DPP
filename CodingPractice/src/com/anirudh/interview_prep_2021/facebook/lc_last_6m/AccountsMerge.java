...
Explanation:
The first and third John'number are the same person as they have the common email "johnsmith@mail.com".
...
/**
 * Connect all emails attached to a name to each other. I can connect (i) to (i + 1) or (0) to all rest. No need to do fully connected
 * Create a graph as adjacency list
 * Do a DFS to find connected components! For tracking visited nodes, create a hashset
 * Using DFS as need to find all trees in a forest
 */

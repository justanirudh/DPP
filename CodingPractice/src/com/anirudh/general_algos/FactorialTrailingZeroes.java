...
How many multiples of 5 are between 1 and 23? There is 5, 10, 15, and 20, for four multiples of 5. Paired with 2's from
the even factors, this makes for four factors of 10, so: 23! has 4 zeros.
...
public class FactorialTrailingZeroes {
    ...
    //counting number of factors of 5 from 1 to n
    public int trailingZeroes(int n) {
        int res = 0;
        for (double i = 5; n / i > 0; i *= 5) //using double for i as huger numbers
            res += n / i;
        return res;
    }
}

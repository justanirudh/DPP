    ...
    public int calculate(String s) {
        ...
        while (i < chars.length) {
            ...
            if (Character.isDigit(c)) { //operand
                ...
                if(!operators.isEmpty() && pri.get(c) - pri.get(operators.peek()) <= 0) { //evaulate higher/same priority ops in stack first
                    while (!operators.isEmpty() && pri.get(c) - pri.get(operators.peek()) <= 0) {

...
public class HW3TestGray {
	...
	/**
	 * Test method for
	 * {@link Gray#gray_SS(BufferedImage, BufferedImage)}
	 *
...
//			System.out.println(timers[rep].toString());
	...
	/**
	 * Test method for
	 * {@link Gray#gray_PS(BufferedImage, BufferedImage)}
	 * .
...
//				System.out.println(timers[rep].toString());
	...
	/**
	 * Test method for
	 * {@link Gray#gray_SS_FJ(FJBufferedImage, FJBufferedImage)}
	 * .
...
//			System.out.println(timers[rep].toString());
	...
	/**
	 * Test method for
	 * {@link Gray#gray_PS_FJ(FJBufferedImage, FJBufferedImage)}
	 * .
